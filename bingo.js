...
Elm.Bingo.make = function (_elm) {
   ...
   var total = function (t) {
      ...
      _L.fromArray([A2($Html.span,
                   ...
                   _L.fromArray([$Html.text($Basics.toString(t))]))]));
   };
   ...
   var resetOrder = function (address) {
   ...
   var Sort = {ctor: "Sort"};
   var sortOption = function (address) {
      return A2($Html.button,
      _L.fromArray([$Html$Attributes.$class("sort")
                   ,A2($Html$Events.onClick,
                   address,
   ...
   model) {
      return function () {
         ...
         {case "Add":
            return function () {
                 var isInvalidModel = $String.isEmpty(model.phraseInput) || $String.isEmpty(model.pointsInput);
                 var entryToAdd = A3(newEntry,
                 model.phraseInput,
                 $BingoUtils.parseInt(model.pointsInput),
                 model.nextId);
                 return isInvalidModel ? model : _U.replace([["phraseInput"
                                                             ,""]
                                                            ,["pointsInput",""]
                                                            ,["entries"
                                                             ,A2($List._op["::"],
